...
export const CTASection = () => {
  ...
  const handleTryFreeClick = () => {
    window.dispatchEvent(
      new CustomEvent("cta_click", { detail: { cta: "cta_try_free" } }),
    );
  ...
  const handleRequestDemoClick = () => {
    window.dispatchEvent(
      new CustomEvent("cta_click", { detail: { cta: "cta_request_demo" } }),
    );
  ...
  const ctaDescription =
    t("cta.description") ||
    "Join leading legal firms in Uzbekistan using Legal Nexus AI";
