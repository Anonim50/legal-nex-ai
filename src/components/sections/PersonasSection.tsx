...
export const PersonasSection = () => {
  ...
  const personaIcons = [Building, Users, GraduationCap, Briefcase];

  // Ensure personas items is an array
  const personaItems = Array.isArray(t("personas.items"))
    ? t("personas.items")
    : [];

  return (
    <section
      className="py-20 md:py-28 bg-gradient-to-b from-white to-neutral-softGray relative"
      ref={sectionRef}
    >
