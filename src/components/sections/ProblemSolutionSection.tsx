...
export const ProblemSolutionSection = () => {
  ...
  const problemTitle =
    t("problem.title") || "Legal challenges in the digital age";
  const problemPoints = Array.isArray(t("problem.points"))
    ? t("problem.points")
    : [];
  ...
  const solutionDescription =
    ...
    "Legal Nexus AI combines cutting-edge artificial intelligence with deep understanding of Uzbekistan's legal system";
  const solutionFeatures = Array.isArray(t("solution.features"))
    ? t("solution.features")
    : [];

  return (
    <section
      className="py-20 md:py-28 bg-gradient-to-b from-white to-neutral-50 relative"
      ref={sectionRef}
    >
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="animate-stagger section-title">{solutionTitle}</h2>
