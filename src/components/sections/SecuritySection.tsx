      ...
      <div className="container-custom relative z-10">
        ...
        <p className="animate-stagger section-subtitle text-center">
          {t("security.description") ||
            "Your data and documents are protected with state-of-the-art security measures"}
        </p>
        ...
        <div className="animate-stagger mt-16 flex justify-center">
          <div className="bg-gradient-to-br from-neutral-softGray to-white rounded-xl p-8 max-w-2xl text-center shadow-lg border border-neutral-100">
            ...
            <p className="text-neutral-gray">
              Legal Nexus AI is fully compliant with both EU GDPR and
              Uzbekistan's data protection laws, ensuring your legal data is
              secure and protected according to international standards.
            </p>
          </div>
        </div>
      </div>
