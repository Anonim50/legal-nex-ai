...
const translations: Translation = {
  ...
  features: {
    analysis: {
      ...
      description:
        "The AI analyzes PDF and Word files, detects risky and controversial clauses.",
    },
    translation: {
      title: "Instant Translation",
      description:
        "Automatically translates contracts into Uzbek, Russian, and English.",
    },
    riskColoring: {
      title: "Risk Color Marking",
      description:
        "Red = high risk, Yellow = warning, Green = safe clauses. Everything is highlighted.",
    },
    summaries: {
      title: "Summaries and Advice",
      description:
        "The AI generates a short summary and provides legal guidance.",
    },
    history: {
      title: "History of Analyses",
      description:
        "Keep and revisit analyzed files anytime. Works via Telegram and Web.",
    },
  },
  testimonials: {
