...
const translations: Translation = {
  ...
  subtitle:
    "Shartnomalarni 30 soniyada tahlil qiling. Bizning AI xavflarni aniqlaydi, matnni tarjima qiladi va huquqiy maslahatlar beradi — o'zbek, rus va ingliz tillarida.",
  cta: {
    title: "Huquqiy ishingizni optimallashtirishga tayyormisiz?",
    description:
      "O'zbekistonning yetakchi huquqiy firmalariga qo'shiling Legal Nexus AI bilan",
  ...
  features: {
    ...
    translation: {
      ...
      description:
        "Shartnomalarni o'zbek, rus va ingliz tillariga avtomatik tarjima qiladi.",
    },
    riskColoring: {
      title: "Xavf darajasi bo'yicha ranglash",
      description:
        "Qizil = yuqori xavf, Sariq = ogohlantirish, Yashil = xavfsiz bandlar. Hammasi ajratilgan.",
    },
    summaries: {
    ...
    history: {
      ...
      description:
        "Tahlil qilingan fayllarni saqlang va istalgan vaqtda ko'rib chiqing. Telegram va veb orqali ishlaydi.",
    },
  },
  testimonials: {
    ...
    items: [
      {
        quote:
          "Ilgari shartnomalarni o'qishga soatlab vaqt sarflardim. Endi bir daqiqa kifoya.",
        name: "Ahmadjon",
        role: "Tadbirkor",
      },
      {
    ...
    items: [
      {
        ...
        answer:
          "PDF va Word (.docx). Faqat faylni yuklang — qolganini biz qilamiz.",
      },
      {
        question: "Bu xavfsizmi?",
        answer:
          "Ha. Biz sizning ruxsatingizsiz shartnomalaringizni saqlamaymiz.",
      },
      {
